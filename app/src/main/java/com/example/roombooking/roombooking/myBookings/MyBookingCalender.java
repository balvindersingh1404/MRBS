...
public class MyBookingCalender {
    ...
    private static void refreshCalendar(TextView monthTextView, GridView calendarGridView,
                                        MyBookingCalenderAdapter materialCalendarAdapter, int month, int year) {
        ...
        if (MyBookingCalenderFragment.mSavedEventsAdapter != null) {
            MyBookingCalenderFragment.mNumEventsOnDay = -1;
            MyBookingCalenderFragment.mSavedEventsAdapter.notifyDataSetChanged();
        }

        MyBookingCalenderFragment.getSavedEventsForCurrentMonth(mMonth, mYear);
    ...
    protected static void previousOnClick(ImageView previousImageView, TextView monthTextView,
                                          GridView calendarGridView, MyBookingCalenderAdapter materialCalendarAdapter) {
    ...
    protected static void nextOnClick(ImageView nextImageView, TextView monthTextView,
                                      ...
                                      MyBookingCalenderAdapter materialCalendarAdapter) {
    ...
    protected static void selectCalendarDay(MyBookingCalenderAdapter materialCalendarAdapter2, int position) {
