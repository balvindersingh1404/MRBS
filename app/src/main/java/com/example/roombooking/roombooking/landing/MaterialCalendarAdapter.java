...
public class MaterialCalendarAdapter extends BaseAdapter {
    ...
    private static MaterialCalendarAdapter.ViewHolder mHolder;
    int mWeekDayNames = 7;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            ...
            mHolder = new MaterialCalendarAdapter.ViewHolder();
            ...
            mHolder = (MaterialCalendarAdapter.ViewHolder) convertView.getTag();
        }
